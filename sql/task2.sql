...
CREATE TABLE sellers (
    ...
    seller_salary      SMALLINT     NOT NULL,
    seller_filial_id   INT FOREIGN KEY REFERENCES filial(filial_id),
    seller_age         TINYINT      NOT NULL
)

INSERT INTO sellers
VALUES (N'Jalə', N'Ələsgərova', N'Sabir', '2000-01-01', 2, 1000, 1, 24),
       ('Murad', N'Ələkbərov', 'Rasim', '2001-02-04', 1, 1200, 1, 23)
...
FROM sales
         JOIN products p ON sales.sale_product_id = p.product_id
GROUP BY product_model_id
